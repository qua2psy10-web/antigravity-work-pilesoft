      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 shadow-lg">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white px-3.5 py-2 rounded text-xs font-medium transition-colors"
          >
                ...
                <tr key={lc.id} className="hover:bg-slate-800/40 transition-colors">
                  <td className="py-3 px-3">
                    <input
                      ...
                      className="bg-slate-800 border border-slate-700 rounded px-2.5 py-1.5 text-slate-100 font-bold text-xs w-48 focus:outline-none focus:border-blue-500"
                    />
                  </td>
                  <td className="py-3 px-3">
                    <select
                      ...
                      className="bg-slate-800 border border-slate-700 rounded px-2 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500"
                    >
                  ...
                  <td className="py-3 px-3">
                    <input
                      ...
                      className="bg-slate-800 border border-slate-700 rounded px-2.5 py-1.5 text-cyan-300 font-bold font-mono text-xs w-24 focus:outline-none focus:border-blue-500"
                    />
                  </td>
                  <td className="py-3 px-3">
                    <input
                      ...
                      className="bg-slate-800 border border-slate-700 rounded px-2.5 py-1.5 text-red-300 font-bold font-mono text-xs w-24 focus:outline-none focus:border-blue-500"
                    />
                  </td>
                  <td className="py-3 px-3">
                    <input
                      ...
                      className="bg-slate-800 border border-slate-700 rounded px-2.5 py-1.5 text-amber-300 font-bold font-mono text-xs w-24 focus:outline-none focus:border-blue-500"
                    />
                  </td>
                  <td className="py-3 px-3">
                    <input
                      ...
                      className="bg-slate-800 border border-slate-700 rounded px-2 py-1.5 text-slate-200 font-mono text-xs w-16 focus:outline-none focus:border-blue-500"
                    />
                  </td>
                  <td className="py-3 px-3">
                    <input
                  ...
                  <td className="py-3 px-3 text-center">
                    <button
                      ...
                      className="text-slate-500 hover:text-red-400 disabled:opacity-30 p-1.5 rounded"
                    >
